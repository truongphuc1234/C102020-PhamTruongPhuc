...
public class UserServlet extends HttpServlet {
    ...
    private void listUserByName(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<User> listUser = userDAO.selectAllUserSortByName();
