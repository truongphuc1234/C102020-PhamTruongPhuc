...
public class ValidationEmployee {
    ...
    public String validateID(String input) throws InvalidInputException {
        boolean isValid = input.matches("^\\d{3}$");
        if (!isValid)
            throw new InvalidInputException("Employee ID must be 3 digits");
        return input;
    }
}
